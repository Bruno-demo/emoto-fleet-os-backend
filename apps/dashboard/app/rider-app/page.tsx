    ...
    <InfoPageLayout>
      ...
      <div className="mx-auto max-w-5xl px-6 py-12 space-y-10">
        ...
        <section className="grid gap-6 md:grid-cols-12 items-center rounded-3xl border border-accent/30 bg-gradient-to-b from-accent/10 via-[#0F172A]/90 to-[#0B0F19] p-8 shadow-2xl shadow-accent/5">
          ...
          <div className="md:col-span-5 flex flex-col items-center justify-center p-6 rounded-2xl bg-[#070B14]/80 border border-white/10 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-1">Open Expo Go on Android or iOS to load app bundle</p>
            </div>
        ...
        <section className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-[#0F172A]/60 p-6 space-y-3">
