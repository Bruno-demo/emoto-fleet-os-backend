            ...
            {formMode === 'direct' ? (
              <>
                ...
                <div className="grid gap-4 sm:grid-cols-3 mt-4">
                  {/* Passport Photo upload (1:1 Square Portrait) */}
                  <div className="space-y-1.5">
                    ...
                    {newPassportPhoto ? (
                      <div className="relative group rounded-xl border border-line overflow-hidden h-[135px] w-full bg-surface-muted flex items-center justify-center">
                        <img src={newPassportPhoto} alt={t("Passport")} className="h-full w-full object-cover" />
                        <button
                          type="button"
                      ...
                      <label className="flex flex-col items-center justify-center rounded-xl border border-dashed border-line bg-surface-hover p-3 cursor-pointer hover:border-accent/40 transition h-[135px] w-full">
                  ...
                  {/* Licence Photo upload (1.58:1 Landscape Card) */}
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                    ...
                    {newLicencePhoto ? (
                      <div className="relative group rounded-xl border border-line overflow-hidden h-[135px] w-full bg-surface-muted flex items-center justify-center">
                        <img src={newLicencePhoto} alt={t("Licence")} className="h-full w-full object-contain p-1" />
                        <button
                          type="button"
                  ...
                  {/* Identity Card Photo upload (1.58:1 Landscape Card) */}
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                    ...
                    {newIdentityCardPhoto ? (
                      <div className="relative group rounded-xl border border-line overflow-hidden h-[135px] w-full bg-surface-muted flex items-center justify-center">
                        <img src={newIdentityCardPhoto} alt={t("ID Card")} className="h-full w-full object-contain p-1" />
                        <button
                          type="button"
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-3 mt-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    {editPassportPhoto ? (
                      <div className="relative group rounded-xl border border-line overflow-hidden h-[135px] w-full bg-surface-muted flex items-center justify-center">
                        <img src={editPassportPhoto} alt={t("Passport")} className="h-full w-full object-cover" />
                        <button
                          type="button"
                      ...
                      <label className="flex flex-col items-center justify-center rounded-xl border border-dashed border-line bg-surface-hover p-3 cursor-pointer hover:border-accent/40 transition h-[135px] w-full">
                        <span className="text-2xl mb-1">👤</span>
                        <span className="text-[11px] font-semibold text-ink text-center leading-tight">
                          {isCompresingEditPassport ? t('Compressing...') : t('Upload Passport')}
                        </span>
                        <span className="text-[9px] text-ink-muted mt-1 text-center">Portrait photo (1:1)</span>
                        <input
                          type="file"
                  ...
                  <div className="space-y-1.5">
                    ...
                    {editLicencePhoto ? (
                      <div className="relative group rounded-xl border border-line overflow-hidden h-[135px] w-full bg-surface-muted flex items-center justify-center">
                        <img src={editLicencePhoto} alt={t("Licence")} className="h-full w-full object-contain p-1" />
                        <button
                          type="button"
                      ...
                      <label className="flex flex-col items-center justify-center rounded-xl border border-dashed border-line bg-surface-hover p-3 cursor-pointer hover:border-accent/40 transition h-[135px] w-full">
                        <span className="text-2xl mb-1">💳</span>
                        <span className="text-[11px] font-semibold text-ink text-center leading-tight">
                          {isCompresingEditLicence ? t('Compressing...') : t('Upload Licence')}
                        </span>
                        <span className="text-[9px] text-ink-muted mt-1 text-center">Landscape driving licence</span>
                        <input
                          type="file"
                  ...
                  {/* Identity Card Photo (1.58:1 Landscape Card) */}
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      <label className="block text-xs font-semibold text-ink-muted uppercase tracking-wider">{t("ID Card Photo")}</label>
                      <span className="text-[10px] text-ink-faint font-medium">Card • Max 15MB</span>
                    ...
                    {editIdentityCardPhoto ? (
                      <div className="relative group rounded-xl border border-line overflow-hidden h-[135px] w-full bg-surface-muted flex items-center justify-center">
                        <img src={editIdentityCardPhoto} alt={t("ID Card")} className="h-full w-full object-contain p-1" />
                        <button
                          type="button"
                      ...
                      <label className="flex flex-col items-center justify-center rounded-xl border border-dashed border-line bg-surface-hover p-3 cursor-pointer hover:border-accent/40 transition h-[135px] w-full">
                        <span className="text-2xl mb-1">📇</span>
                        <span className="text-[11px] font-semibold text-ink text-center leading-tight">
                          {isCompresingEditIdentity ? t('Compressing...') : t('Upload ID Card')}
                        </span>
                        <span className="text-[9px] text-ink-muted mt-1 text-center">Landscape National ID</span>
                        <input
                          type="file"
