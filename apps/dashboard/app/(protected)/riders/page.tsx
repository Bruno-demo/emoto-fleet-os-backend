          ...
          <div className="mb-6 rounded-2xl border border-white/[0.08] bg-surface-muted p-5 animate-scale-in">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="rounded-lg p-1.5 text-ink-muted hover:text-ink hover:bg-white/5"
              >
                <X size={16} />
              </button>
            </div>
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              <button
                ...
                className="rounded-xl bg-accent px-4 py-2 text-sm font-semibold text-ink transition hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed"
              >
