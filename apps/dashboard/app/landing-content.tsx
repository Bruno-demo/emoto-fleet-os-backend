...
const faqs = [
  ...
  { q: 'How does pricing work?', a: 'Fleet OS offers transparent per-bike pricing with three tiers: Safety Core (5,000 RWF/bike/month plus 20,000 RWF setup & installation) for essentials, Operations Plus (10,000 RWF/bike/month plus 20,000 RWF setup & installation) for full features, and Enterprise for custom deployments with dedicated support and SLA.' },
