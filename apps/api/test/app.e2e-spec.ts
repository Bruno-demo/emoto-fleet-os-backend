...
describe('Auth, RBAC, and Provisioning (e2e)', () => {
  ...
  describe('Insurer-Bike Assignment Validation and Access Restrictions', () => {
    ...
    it('allows INSURER to fetch assignments list for covered bikes', async () => {
      const response = await request(httpServer)
    ...
    it('allows INSURER to fetch road features but returns empty results', async () => {
      const response = await request(httpServer)
