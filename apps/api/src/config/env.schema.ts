...
export const envSchema = z
  .object({
    ...
    ROAD_FEATURE_CACHE_TTL_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(3600),
    ROAD_FEATURE_REFRESH_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(86_400),
    ROAD_FEATURE_MAX_RESULTS: z.coerce.number().int().positive().default(600),
    ROAD_SPEED_LIMIT_RADIUS_METERS: z.coerce
      .number()
      .int()
      .positive()
      .default(80),
    ...
    TRIP_SCORE_WEIGHT_HOSPITAL_ZONE: z.coerce
      .number()
      .nonnegative()
      .default(1.2),
    ...
    TRIP_SCORE_WEIGHT_HARSH_CORNER: z.coerce
      .number()
      .nonnegative()
      .default(0.8),
    TRIP_SCORE_WEIGHT_CRASH: z.coerce.number().nonnegative().default(4),
    TRIP_SCORE_WEIGHT_THEFT_SUSPECTED: z.coerce
      .number()
      .nonnegative()
      .default(3),
